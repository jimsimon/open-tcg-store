...
INSERT INTO `__new_inventory_item`("id", "organization_id", "product_id", "condition", "price", "created_at", "updated_at", "created_by", "updated_by") SELECT "id", "organization_id", "product_id", "condition", ROUND("price" * 100), "created_at", "updated_at", "created_by", "updated_by" FROM `inventory_item`;--> statement-breakpoint
...
--> statement-breakpoint
INSERT INTO `__new_order`("id", "organization_id", "order_number", "customer_name", "user_id", "status", "total_amount", "created_at") SELECT "id", "organization_id", "order_number", "customer_name", "user_id", "status", ROUND("total_amount" * 100), "created_at" FROM `order`;--> statement-breakpoint
...
--> statement-breakpoint
INSERT INTO `__new_lot`("id", "organization_id", "name", "description", "amount_paid", "acquisition_date", "created_at", "updated_at", "created_by", "updated_by") SELECT "id", "organization_id", "name", "description", ROUND("amount_paid" * 100), "acquisition_date", "created_at", "updated_at", "created_by", "updated_by" FROM `lot`;--> statement-breakpoint
...
--> statement-breakpoint
INSERT INTO `__new_lot_item`("id", "lot_id", "product_id", "condition", "quantity", "cost_basis", "cost_overridden", "inventory_item_stock_id", "created_at", "updated_at") SELECT "id", "lot_id", "product_id", "condition", "quantity", ROUND("cost_basis" * 100), "cost_overridden", "inventory_item_stock_id", "created_at", "updated_at" FROM `lot_item`;--> statement-breakpoint
