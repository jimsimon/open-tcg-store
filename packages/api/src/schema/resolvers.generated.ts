...
export const resolvers: Resolvers = {
  Query: {
    getActiveStoreLocation: Query_getActiveStoreLocation,
    getAllStoreLocations: Query_getAllStoreLocations,
    getBackupSettings: Query_getBackupSettings,
    getCard: Query_getCard,
    getEmployeeStoreLocations: Query_getEmployeeStoreLocations,
    getIntegrationSettings: Query_getIntegrationSettings,
    getInventory: Query_getInventory,
    getInventoryItem: Query_getInventoryItem,
    getInventoryItemDetails: Query_getInventoryItemDetails,
    getOrders: Query_getOrders,
    getProduct: Query_getProduct,
    getProductListings: Query_getProductListings,
    getSets: Query_getSets,
    getShoppingCart: Query_getShoppingCart,
  ...
  Mutation: {
    addInventoryItem: Mutation_addInventoryItem,
    addStock: Mutation_addStock,
    addStoreLocation: Mutation_addStoreLocation,
    addToCart: Mutation_addToCart,
    bulkDeleteStock: Mutation_bulkDeleteStock,
    bulkUpdateStock: Mutation_bulkUpdateStock,
    cancelOrder: Mutation_cancelOrder,
    checkoutWithCart: Mutation_checkoutWithCart,
    clearCart: Mutation_clearCart,
    deleteInventoryItem: Mutation_deleteInventoryItem,
    deleteStock: Mutation_deleteStock,
    firstTimeSetup: Mutation_firstTimeSetup,
    removeFromCart: Mutation_removeFromCart,
    removeStoreLocation: Mutation_removeStoreLocation,
    setActiveStoreLocation: Mutation_setActiveStoreLocation,
    submitOrder: Mutation_submitOrder,
    triggerBackup: Mutation_triggerBackup,
    triggerRestore: Mutation_triggerRestore,
    updateBackupSettings: Mutation_updateBackupSettings,
    updateInventoryItem: Mutation_updateInventoryItem,
    updateItemInCart: Mutation_updateItemInCart,
    updateOrderStatus: Mutation_updateOrderStatus,
    updateQuickBooksIntegration: Mutation_updateQuickBooksIntegration,
    updateShopifyIntegration: Mutation_updateShopifyIntegration,
    updateStock: Mutation_updateStock,
    updateStoreLocation: Mutation_updateStoreLocation,
    updateStoreSettings: Mutation_updateStoreSettings,
    updateStripeIntegration: Mutation_updateStripeIntegration,
  },
};
